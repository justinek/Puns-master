...
print "sentenecID,sentenceType,c1,c2,maxKL"
        ...
        if len(subset1) > 0:
            ...
            for subset2 in contextSubsets:
                ...
                if len(subset2) > 0:
                    ...
                    KL = math.log(hom1c1Prob/hom1c2Prob)*hom1c1Prob+math.log(hom2c1Prob/hom2c2Prob)*hom2c1Prob
                    # computes KL normalized by context probability
                    # P(context) = P(word in context)^(size(context))
                    
                    # something to tweak
                    probWordInContext = 0.7
