...
# word pair relatedness from relatedness_orig.csv 
...
print "uniqueID,sentenceType,isOrig,p_m1_given_w,p_m2_given_w"
...
for k, v in sentenceDict.iteritems():
    ...
    for fVector in focusVectors:
        ...
        probWordInFocus = 0.8 # can be tweaked
        ...
        for j in range(numWords):
            ...
            if fVector[j] is True:
                ...
                logProbWordGivenM1 = wordProbDict[wordj] + m1Relatedness[j]
                logProbWordGivenM2 = wordProbDict[wordj] + m2Relatedness[j]
    ...
    print uniqueID + "," + sentenceType + "," + str(isOrig) + "," + str(probM1) + "," + str(probM2)
