...
for k, v in sentenceDict.iteritems():
    ...
    for fVector in focusVectors:
        ...
        for j in range(numWords):
            ...
            if fVector[j] is True:
                ...
                logProbWordGivenM1 = m1Ngram[j] + m1Relatedness[j]
                logProbWordGivenM2 = m2Ngram[j] + m2Relatedness[j]
    ...
    probWordInFocusGivenM1 = []
    probWordInFocusGivenM2 = []
    for i in range(numWords):
        probWord_i_in_focus_m1 = 0
        probWord_i_in_focus_m2 = 0
        for j in range(len(focusVectors)):
            vec = focusVectors[j]
            probWord_i_in_focus_m1 += vec[i] * normalizedFWGivenM1[j]
            probWord_i_in_focus_m2 += vec[i] * normalizedFWGivenM2[j]
        probWordInFocusGivenM1.append(probWord_i_in_focus_m1)
        probWordInFocusGivenM2.append(probWord_i_in_focus_m2)
    # normalize so probabiity of each word being in focus sums up to 1
    probWordInFocusGivenM1 = normListSumTo(probWordInFocusGivenM1, 1)
    probWordInFocusGivenM2 = normListSumTo(probWordInFocusGivenM2, 1)
    ...
    KL2 = 0
    for i in range(numWords):
        KL1 = KL1 + math.log(probWordInFocusGivenM1[i] / probWordInFocusGivenM2[i]) * probWordInFocusGivenM1[i]
        KL2 = KL2 + math.log(probWordInFocusGivenM2[i] / probWordInFocusGivenM1[i]) * probWordInFocusGivenM2[i]
        ...
        #print sumKL
    #print "Words: " + ";".join(words)
    #print probWordInFocusGivenM1
    #print probWordInFocusGivenM2
    #print focusVectors
    #print normalizedFWGivenM1
    #print normalizedFWGivenM2
    #print "maxM1:",
    #print focusVectors[maxFWGivenM1Index]
    #print "maxM2:",
    #print focusVectors[maxFWGivenM2Index]
