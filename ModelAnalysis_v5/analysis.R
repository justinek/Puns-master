...
distinct_3gram = read.csv("distinctiveness_v1.csv")
...
distinct_min_3gram = read.csv("distinctiveness_v2.csv")
...
distinct_byWord_3gram = read.csv("distinctiveness_byWords_v1.csv")
